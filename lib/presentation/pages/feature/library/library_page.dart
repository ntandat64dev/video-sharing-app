...
class _LibraryPageState extends State<LibraryPage> {
                            ...
                            children: [
                              ...
                              InkWell(
                                onTap: () => showNewPlaylistBottomSheet(
                                    context: context, onRefresh: () => setStatePlaylists(() {})),
                                child: Padding(
                                  padding: const EdgeInsets.symmetric(vertical: 8.0),
                                  child: ListTile(
                                    leading: Container(
  ...
  void showNewPlaylistBottomSheet({required BuildContext context, void Function()? onRefresh}) {
                          ...
                          Expanded(
                            child: Padding(
                              ...
                              child: bottomSheetConfirmButton(
                                onPressed: () async {
                                  final createdPlaylist = await playlistRepository.createPlaylist(
                                    Playlist.post(
